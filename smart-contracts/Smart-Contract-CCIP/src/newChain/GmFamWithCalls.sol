...
contract GmFamWithCalls is ERC721, ERC721Burnable, ERC721Royalty, AccessControl, StringConverter {
    ...
    address public OriginalChainReceiverContractAddres = address(0);
    ...
    function setOriginalChainReceiverContractAddres(address _OriginalChainReceiverContractAddres) public onlyOwner {
        OriginalChainReceiverContractAddres = _OriginalChainReceiverContractAddres;
    }
    ...
    function goBackToOriginalCollection(uint256 tokenId,string memory _signature) public {
        ...
        Client.EVM2AnyMessage memory message = Client.EVM2AnyMessage({
            receiver: abi.encode(OriginalChainReceiverContractAddres),
    ...
    function makeAlbitratyCalls(bytes memory _functionAndData, address _where)
        public
    ...
    function viewOriginalChainReceiverContractAddress() public view returns (address) {
        return OriginalChainReceiverContractAddres;
    }
